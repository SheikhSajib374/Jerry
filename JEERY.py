...
def login():
	banner()
	SAJIBj('\033[1;96m[1] File \n [2] EXIT ')
	SAJIBj('\033[0;97m===============================================')
	SAJIB= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if SAJIB in ['m']:
		public()
	elif SAJIB in ['1']:
		crack_file()
...
def passwrd():
	...
	print('')
	SAJIBj('==========================================')
	SAJIBj('CLONING COMPLETE .......... ')
	print(f'{h}[{h}💚{h}]{h} ALIVE : {h}%s '%(ok))
	input('CLICK ENTER TO EXIT ')
		
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r{bo}[ALIVE-😝] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
